...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_2_B, 0xCB90")
{
	ClearRegisters();
	BC.SetHighByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_2_B);

	REQUIRE(numberOfCycles == 2);
	REQUIRE(AF.HighByte() == 0x00);
	REQUIRE(AF.LowByte() == 0b1111'0000);
	REQUIRE(BC.HighByte() == 0b1111'1011);
	REQUIRE(BC.LowByte() == 0x00);
	REQUIRE(DE.Value() == 0x00'00);
	REQUIRE(HL.Value() == 0x00'00);
	REQUIRE(SP.Value() == 0x00'00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_2_C, 0xCB91")
{
	ClearRegisters();
	BC.SetLowByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_2_C);

	REQUIRE(numberOfCycles == 2);
	REQUIRE(AF.HighByte() == 0x00);
	REQUIRE(AF.LowByte() == 0b1111'0000);
	REQUIRE(BC.LowByte() == 0b1111'1011);
	REQUIRE(BC.HighByte() == 0x00);
	REQUIRE(DE.Value() == 0x00'00);
	REQUIRE(HL.Value() == 0x00'00);
	REQUIRE(SP.Value() == 0x00'00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_2_D, 0xCB92")
{
	ClearRegisters();
	DE.SetHighByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_2_D);

	REQUIRE(numberOfCycles == 2);
	REQUIRE(AF.HighByte() == 0x00);
	REQUIRE(AF.LowByte() == 0b1111'0000);
	REQUIRE(BC.Value() == 0x00'00);
	REQUIRE(DE.HighByte() == 0b1111'1011);
	REQUIRE(DE.LowByte() == 0x00);
	REQUIRE(HL.Value() == 0x00'00);
	REQUIRE(SP.Value() == 0x00'00);
	REQUIRE(PC.Value() == 0x00'00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_2_E, 0xCB93")
{
	ClearRegisters();
	DE.SetLowByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_2_E);

	REQUIRE(numberOfCycles == 2);
	REQUIRE(AF.HighByte() == 0x00);
	REQUIRE(AF.LowByte() == 0b1111'0000);
	REQUIRE(BC.Value() == 0x00'00);
	REQUIRE(DE.LowByte() == 0b1111'1011);
	REQUIRE(DE.HighByte() == 0x00);
	REQUIRE(HL.Value() == 0x00'00);
	REQUIRE(SP.Value() == 0x00'00);
	REQUIRE(PC.Value() == 0x00'00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_2_H, 0xCB94")
{
	ClearRegisters();
	HL.SetHighByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_2_H);
	...
	REQUIRE(BC.Value() == 0x00'00);
	REQUIRE(DE.Value() == 0x00'00);
	REQUIRE(HL.HighByte() == 0b1111'1011);
	REQUIRE(HL.LowByte() == 0x00);
	REQUIRE(SP.Value() == 0x00'00);
	REQUIRE(PC.Value() == 0x00'00);
	REQUIRE(IE == 0x00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_2_L, 0xCB95")
{
	ClearRegisters();
	HL.SetLowByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_2_L);
	...
	REQUIRE(BC.Value() == 0x00'00);
	REQUIRE(DE.Value() == 0x00'00);
	REQUIRE(HL.LowByte() == 0b1111'1011);
	REQUIRE(HL.HighByte() == 0x00);
	REQUIRE(SP.Value() == 0x00'00);
	REQUIRE(PC.Value() == 0x00'00);
	REQUIRE(IE == 0x00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_2_HL_NI, 0xCB96")
{
	ClearRegisters();
	AF.SetLowByte(0b1111'0000);
	HL.SetValue(interruptAddress);
	...
	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_2_HL_NI);
	...
	REQUIRE(SP.Value() == 0x00'00);
	REQUIRE(PC.Value() == 0x00'00);
	REQUIRE(IE == 0b1111'1011);
}

TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_2_A, 0xCB97")
{
	ClearRegisters();
	AF.SetHighByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_2_A);

	REQUIRE(numberOfCycles == 2);
	REQUIRE(AF.HighByte() == 0b1111'1011);
	REQUIRE(AF.LowByte() == 0b1111'0000);
	REQUIRE(BC.Value() == 0x00'00);
	REQUIRE(DE.Value() == 0x00'00);
	REQUIRE(HL.Value() == 0x00'00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_3_B, 0xCB98")
{
	ClearRegisters();
	BC.SetHighByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_3_B);

	REQUIRE(numberOfCycles == 2);
	REQUIRE(AF.HighByte() == 0x00);
	REQUIRE(AF.LowByte() == 0b1111'0000);
	REQUIRE(BC.HighByte() == 0b1111'0111);
	REQUIRE(BC.LowByte() == 0x00);
	REQUIRE(DE.Value() == 0x00'00);
	REQUIRE(HL.Value() == 0x00'00);
	REQUIRE(SP.Value() == 0x00'00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_3_C, 0xCB99")
{
	ClearRegisters();
	BC.SetLowByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_3_C);

	REQUIRE(numberOfCycles == 2);
	REQUIRE(AF.HighByte() == 0x00);
	REQUIRE(AF.LowByte() == 0b1111'0000);
	REQUIRE(BC.LowByte() == 0b1111'0111);
	REQUIRE(BC.HighByte() == 0x00);
	REQUIRE(DE.Value() == 0x00'00);
	REQUIRE(HL.Value() == 0x00'00);
	REQUIRE(SP.Value() == 0x00'00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_3_D, 0xCB9A")
{
	ClearRegisters();
	DE.SetHighByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_3_D);

	REQUIRE(numberOfCycles == 2);
	REQUIRE(AF.HighByte() == 0x00);
	REQUIRE(AF.LowByte() == 0b1111'0000);
	REQUIRE(BC.Value() == 0x00'00);
	REQUIRE(DE.HighByte() == 0b1111'0111);
	REQUIRE(DE.LowByte() == 0x00);
	REQUIRE(HL.Value() == 0x00'00);
	REQUIRE(SP.Value() == 0x00'00);
	REQUIRE(PC.Value() == 0x00'00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_3_E, 0xCB9B")
{
	ClearRegisters();
	DE.SetLowByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_3_E);

	REQUIRE(numberOfCycles == 2);
	REQUIRE(AF.HighByte() == 0x00);
	REQUIRE(AF.LowByte() == 0b1111'0000);
	REQUIRE(BC.Value() == 0x00'00);
	REQUIRE(DE.LowByte() == 0b1111'0111);
	REQUIRE(DE.HighByte() == 0x00);
	REQUIRE(HL.Value() == 0x00'00);
	REQUIRE(SP.Value() == 0x00'00);
	REQUIRE(PC.Value() == 0x00'00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_3_H, 0xCB9C")
{
	ClearRegisters();
	HL.SetHighByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_3_H);
	...
	REQUIRE(BC.Value() == 0x00'00);
	REQUIRE(DE.Value() == 0x00'00);
	REQUIRE(HL.HighByte() == 0b1111'0111);
	REQUIRE(HL.LowByte() == 0x00);
	REQUIRE(SP.Value() == 0x00'00);
	REQUIRE(PC.Value() == 0x00'00);
	REQUIRE(IE == 0x00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_3_L, 0xCB9D")
{
	ClearRegisters();
	HL.SetLowByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_3_L);
	...
	REQUIRE(BC.Value() == 0x00'00);
	REQUIRE(DE.Value() == 0x00'00);
	REQUIRE(HL.LowByte() == 0b1111'0111);
	REQUIRE(HL.HighByte() == 0x00);
	REQUIRE(SP.Value() == 0x00'00);
	REQUIRE(PC.Value() == 0x00'00);
	REQUIRE(IE == 0x00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_3_HL_NI, 0xCB9E")
{
	ClearRegisters();
	AF.SetLowByte(0b1111'0000);
	HL.SetValue(interruptAddress);
	...
	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_3_HL_NI);
	...
	REQUIRE(SP.Value() == 0x00'00);
	REQUIRE(PC.Value() == 0x00'00);
	REQUIRE(IE == 0b1111'0111);
}

TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_3_A, 0xCB9F")
{
	ClearRegisters();
	AF.SetHighByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_3_A);

	REQUIRE(numberOfCycles == 2);
	REQUIRE(AF.HighByte() == 0b1111'0111);
	REQUIRE(AF.LowByte() == 0b1111'0000);
	REQUIRE(BC.Value() == 0x00'00);
	REQUIRE(DE.Value() == 0x00'00);
	REQUIRE(HL.Value() == 0x00'00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_4_B, 0xCBA0")
{
	ClearRegisters();
	BC.SetHighByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_4_B);

	REQUIRE(numberOfCycles == 2);
	REQUIRE(AF.HighByte() == 0x00);
	REQUIRE(AF.LowByte() == 0b1111'0000);
	REQUIRE(BC.HighByte() == 0b1110'1111);
	REQUIRE(BC.LowByte() == 0x00);
	REQUIRE(DE.Value() == 0x00'00);
	REQUIRE(HL.Value() == 0x00'00);
	REQUIRE(SP.Value() == 0x00'00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_4_C, 0xCBA1")
{
	ClearRegisters();
	BC.SetLowByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_4_C);

	REQUIRE(numberOfCycles == 2);
	REQUIRE(AF.HighByte() == 0x00);
	REQUIRE(AF.LowByte() == 0b1111'0000);
	REQUIRE(BC.LowByte() == 0b1110'1111);
	REQUIRE(BC.HighByte() == 0x00);
	REQUIRE(DE.Value() == 0x00'00);
	REQUIRE(HL.Value() == 0x00'00);
	REQUIRE(SP.Value() == 0x00'00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_4_D, 0xCBA2")
{
	ClearRegisters();
	DE.SetHighByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_4_D);

	REQUIRE(numberOfCycles == 2);
	REQUIRE(AF.HighByte() == 0x00);
	REQUIRE(AF.LowByte() == 0b1111'0000);
	REQUIRE(BC.Value() == 0x00'00);
	REQUIRE(DE.HighByte() == 0b1110'1111);
	REQUIRE(DE.LowByte() == 0x00);
	REQUIRE(HL.Value() == 0x00'00);
	REQUIRE(SP.Value() == 0x00'00);
	REQUIRE(PC.Value() == 0x00'00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_4_E, 0xCBA3")
{
	ClearRegisters();
	DE.SetLowByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_4_E);

	REQUIRE(numberOfCycles == 2);
	REQUIRE(AF.HighByte() == 0x00);
	REQUIRE(AF.LowByte() == 0b1111'0000);
	REQUIRE(BC.Value() == 0x00'00);
	REQUIRE(DE.LowByte() == 0b1110'1111);
	REQUIRE(DE.HighByte() == 0x00);
	REQUIRE(HL.Value() == 0x00'00);
	REQUIRE(SP.Value() == 0x00'00);
	REQUIRE(PC.Value() == 0x00'00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_4_H, 0xCBA4")
{
	ClearRegisters();
	HL.SetHighByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_4_H);
	...
	REQUIRE(BC.Value() == 0x00'00);
	REQUIRE(DE.Value() == 0x00'00);
	REQUIRE(HL.HighByte() == 0b1110'1111);
	REQUIRE(HL.LowByte() == 0x00);
	REQUIRE(SP.Value() == 0x00'00);
	REQUIRE(PC.Value() == 0x00'00);
	REQUIRE(IE == 0x00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_4_L, 0xCBA5")
{
	ClearRegisters();
	HL.SetLowByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_4_L);
	...
	REQUIRE(BC.Value() == 0x00'00);
	REQUIRE(DE.Value() == 0x00'00);
	REQUIRE(HL.LowByte() == 0b1110'1111);
	REQUIRE(HL.HighByte() == 0x00);
	REQUIRE(SP.Value() == 0x00'00);
	REQUIRE(PC.Value() == 0x00'00);
	REQUIRE(IE == 0x00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_4_HL_NI, 0xCBA6")
{
	ClearRegisters();
	AF.SetLowByte(0b1111'0000);
	HL.SetValue(interruptAddress);
	...
	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_4_HL_NI);
	...
	REQUIRE(SP.Value() == 0x00'00);
	REQUIRE(PC.Value() == 0x00'00);
	REQUIRE(IE == 0b1110'1111);
}

TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_4_A, 0xCBA7")
{
	ClearRegisters();
	AF.SetHighByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_4_A);

	REQUIRE(numberOfCycles == 2);
	REQUIRE(AF.HighByte() == 0b1110'1111);
	REQUIRE(AF.LowByte() == 0b1111'0000);
	REQUIRE(BC.Value() == 0x00'00);
	REQUIRE(DE.Value() == 0x00'00);
	REQUIRE(HL.Value() == 0x00'00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_5_B, 0xCBA8")
{
	ClearRegisters();
	BC.SetHighByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_5_B);

	REQUIRE(numberOfCycles == 2);
	REQUIRE(AF.HighByte() == 0x00);
	REQUIRE(AF.LowByte() == 0b1111'0000);
	REQUIRE(BC.HighByte() == 0b1101'1111);
	REQUIRE(BC.LowByte() == 0x00);
	REQUIRE(DE.Value() == 0x00'00);
	REQUIRE(HL.Value() == 0x00'00);
	REQUIRE(SP.Value() == 0x00'00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_5_C, 0xCBA9")
{
	ClearRegisters();
	BC.SetLowByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_5_C);

	REQUIRE(numberOfCycles == 2);
	REQUIRE(AF.HighByte() == 0x00);
	REQUIRE(AF.LowByte() == 0b1111'0000);
	REQUIRE(BC.LowByte() == 0b1101'1111);
	REQUIRE(BC.HighByte() == 0x00);
	REQUIRE(DE.Value() == 0x00'00);
	REQUIRE(HL.Value() == 0x00'00);
	REQUIRE(SP.Value() == 0x00'00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_5_D, 0xCBAA")
{
	ClearRegisters();
	DE.SetHighByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_5_D);

	REQUIRE(numberOfCycles == 2);
	REQUIRE(AF.HighByte() == 0x00);
	REQUIRE(AF.LowByte() == 0b1111'0000);
	REQUIRE(BC.Value() == 0x00'00);
	REQUIRE(DE.HighByte() == 0b1101'1111);
	REQUIRE(DE.LowByte() == 0x00);
	REQUIRE(HL.Value() == 0x00'00);
	REQUIRE(SP.Value() == 0x00'00);
	REQUIRE(PC.Value() == 0x00'00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_5_E, 0xCBAB")
{
	ClearRegisters();
	DE.SetLowByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_5_E);

	REQUIRE(numberOfCycles == 2);
	REQUIRE(AF.HighByte() == 0x00);
	REQUIRE(AF.LowByte() == 0b1111'0000);
	REQUIRE(BC.Value() == 0x00'00);
	REQUIRE(DE.LowByte() == 0b1101'1111);
	REQUIRE(DE.HighByte() == 0x00);
	REQUIRE(HL.Value() == 0x00'00);
	REQUIRE(SP.Value() == 0x00'00);
	REQUIRE(PC.Value() == 0x00'00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_5_H, 0xCBAC")
{
	ClearRegisters();
	HL.SetHighByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_5_H);
	...
	REQUIRE(BC.Value() == 0x00'00);
	REQUIRE(DE.Value() == 0x00'00);
	REQUIRE(HL.HighByte() == 0b1101'1111);
	REQUIRE(HL.LowByte() == 0x00);
	REQUIRE(SP.Value() == 0x00'00);
	REQUIRE(PC.Value() == 0x00'00);
	REQUIRE(IE == 0x00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_5_L, 0xCBAD")
{
	ClearRegisters();
	HL.SetLowByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_5_L);
	...
	REQUIRE(BC.Value() == 0x00'00);
	REQUIRE(DE.Value() == 0x00'00);
	REQUIRE(HL.LowByte() == 0b1101'1111);
	REQUIRE(HL.HighByte() == 0x00);
	REQUIRE(SP.Value() == 0x00'00);
	REQUIRE(PC.Value() == 0x00'00);
	REQUIRE(IE == 0x00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_5_HL_NI, 0xCBAE")
{
	ClearRegisters();
	AF.SetLowByte(0b1111'0000);
	HL.SetValue(interruptAddress);
	...
	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_5_HL_NI);
	...
	REQUIRE(SP.Value() == 0x00'00);
	REQUIRE(PC.Value() == 0x00'00);
	REQUIRE(IE == 0b1101'1111);
}

TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_5_A, 0xCBAF")
{
	ClearRegisters();
	AF.SetHighByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_5_A);

	REQUIRE(numberOfCycles == 2);
	REQUIRE(AF.HighByte() == 0b1101'1111);
	REQUIRE(AF.LowByte() == 0b1111'0000);
	REQUIRE(BC.Value() == 0x00'00);
	REQUIRE(DE.Value() == 0x00'00);
	REQUIRE(HL.Value() == 0x00'00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_6_B, 0xCBB0")
{
	ClearRegisters();
	BC.SetHighByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_6_B);

	REQUIRE(numberOfCycles == 2);
	REQUIRE(AF.HighByte() == 0x00);
	REQUIRE(AF.LowByte() == 0b1111'0000);
	REQUIRE(BC.HighByte() == 0b1011'1111);
	REQUIRE(BC.LowByte() == 0x00);
	REQUIRE(DE.Value() == 0x00'00);
	REQUIRE(HL.Value() == 0x00'00);
	REQUIRE(SP.Value() == 0x00'00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_6_C, 0xCBB1")
{
	ClearRegisters();
	BC.SetLowByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_6_C);

	REQUIRE(numberOfCycles == 2);
	REQUIRE(AF.HighByte() == 0x00);
	REQUIRE(AF.LowByte() == 0b1111'0000);
	REQUIRE(BC.LowByte() == 0b1011'1111);
	REQUIRE(BC.HighByte() == 0x00);
	REQUIRE(DE.Value() == 0x00'00);
	REQUIRE(HL.Value() == 0x00'00);
	REQUIRE(SP.Value() == 0x00'00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_6_D, 0xCBB2")
{
	ClearRegisters();
	DE.SetHighByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_6_D);

	REQUIRE(numberOfCycles == 2);
	REQUIRE(AF.HighByte() == 0x00);
	REQUIRE(AF.LowByte() == 0b1111'0000);
	REQUIRE(BC.Value() == 0x00'00);
	REQUIRE(DE.HighByte() == 0b1011'1111);
	REQUIRE(DE.LowByte() == 0x00);
	REQUIRE(HL.Value() == 0x00'00);
	REQUIRE(SP.Value() == 0x00'00);
	REQUIRE(PC.Value() == 0x00'00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_6_E, 0xCBB3")
{
	ClearRegisters();
	DE.SetLowByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_6_E);

	REQUIRE(numberOfCycles == 2);
	REQUIRE(AF.HighByte() == 0x00);
	REQUIRE(AF.LowByte() == 0b1111'0000);
	REQUIRE(BC.Value() == 0x00'00);
	REQUIRE(DE.LowByte() == 0b1011'1111);
	REQUIRE(DE.HighByte() == 0x00);
	REQUIRE(HL.Value() == 0x00'00);
	REQUIRE(SP.Value() == 0x00'00);
	REQUIRE(PC.Value() == 0x00'00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_6_H, 0xCBB4")
{
	ClearRegisters();
	HL.SetHighByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_6_H);
	...
	REQUIRE(BC.Value() == 0x00'00);
	REQUIRE(DE.Value() == 0x00'00);
	REQUIRE(HL.HighByte() == 0b1011'1111);
	REQUIRE(HL.LowByte() == 0x00);
	REQUIRE(SP.Value() == 0x00'00);
	REQUIRE(PC.Value() == 0x00'00);
	REQUIRE(IE == 0x00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_6_L, 0xCBB5")
{
	ClearRegisters();
	HL.SetLowByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_6_L);
	...
	REQUIRE(BC.Value() == 0x00'00);
	REQUIRE(DE.Value() == 0x00'00);
	REQUIRE(HL.LowByte() == 0b1011'1111);
	REQUIRE(HL.HighByte() == 0x00);
	REQUIRE(SP.Value() == 0x00'00);
	REQUIRE(PC.Value() == 0x00'00);
	REQUIRE(IE == 0x00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_6_HL_NI, 0xCBB6")
{
	ClearRegisters();
	AF.SetLowByte(0b1111'0000);
	HL.SetValue(interruptAddress);
	...
	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_6_HL_NI);
	...
	REQUIRE(SP.Value() == 0x00'00);
	REQUIRE(PC.Value() == 0x00'00);
	REQUIRE(IE == 0b1011'1111);
}

TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_6_A, 0xCBB7")
{
	ClearRegisters();
	AF.SetHighByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_6_A);

	REQUIRE(numberOfCycles == 2);
	REQUIRE(AF.HighByte() == 0b1011'1111);
	REQUIRE(AF.LowByte() == 0b1111'0000);
	REQUIRE(BC.Value() == 0x00'00);
	REQUIRE(DE.Value() == 0x00'00);
	REQUIRE(HL.Value() == 0x00'00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_7_B, 0xCBB8")
{
	ClearRegisters();
	BC.SetHighByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_7_B);

	REQUIRE(numberOfCycles == 2);
	REQUIRE(AF.HighByte() == 0x00);
	REQUIRE(AF.LowByte() == 0b1111'0000);
	REQUIRE(BC.HighByte() == 0b0111'1111);
	REQUIRE(BC.LowByte() == 0x00);
	REQUIRE(DE.Value() == 0x00'00);
	REQUIRE(HL.Value() == 0x00'00);
	REQUIRE(SP.Value() == 0x00'00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_7_C, 0xCBB9")
{
	ClearRegisters();
	BC.SetLowByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_7_C);

	REQUIRE(numberOfCycles == 2);
	REQUIRE(AF.HighByte() == 0x00);
	REQUIRE(AF.LowByte() == 0b1111'0000);
	REQUIRE(BC.LowByte() == 0b0111'1111);
	REQUIRE(BC.HighByte() == 0x00);
	REQUIRE(DE.Value() == 0x00'00);
	REQUIRE(HL.Value() == 0x00'00);
	REQUIRE(SP.Value() == 0x00'00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_7_D, 0xCBBA")
{
	ClearRegisters();
	DE.SetHighByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_7_D);

	REQUIRE(numberOfCycles == 2);
	REQUIRE(AF.HighByte() == 0x00);
	REQUIRE(AF.LowByte() == 0b1111'0000);
	REQUIRE(BC.Value() == 0x00'00);
	REQUIRE(DE.HighByte() == 0b0111'1111);
	REQUIRE(DE.LowByte() == 0x00);
	REQUIRE(HL.Value() == 0x00'00);
	REQUIRE(SP.Value() == 0x00'00);
	REQUIRE(PC.Value() == 0x00'00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_7_E, 0xCBBB")
{
	ClearRegisters();
	DE.SetLowByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_7_E);

	REQUIRE(numberOfCycles == 2);
	REQUIRE(AF.HighByte() == 0x00);
	REQUIRE(AF.LowByte() == 0b1111'0000);
	REQUIRE(BC.Value() == 0x00'00);
	REQUIRE(DE.LowByte() == 0b0111'1111);
	REQUIRE(DE.HighByte() == 0x00);
	REQUIRE(HL.Value() == 0x00'00);
	REQUIRE(SP.Value() == 0x00'00);
	REQUIRE(PC.Value() == 0x00'00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_7_H, 0xCBBC")
{
	ClearRegisters();
	HL.SetHighByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_7_H);
	...
	REQUIRE(BC.Value() == 0x00'00);
	REQUIRE(DE.Value() == 0x00'00);
	REQUIRE(HL.HighByte() == 0b0111'1111);
	REQUIRE(HL.LowByte() == 0x00);
	REQUIRE(SP.Value() == 0x00'00);
	REQUIRE(PC.Value() == 0x00'00);
	REQUIRE(IE == 0x00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_7_L, 0xCBBD")
{
	ClearRegisters();
	HL.SetLowByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_7_L);
	...
	REQUIRE(BC.Value() == 0x00'00);
	REQUIRE(DE.Value() == 0x00'00);
	REQUIRE(HL.LowByte() == 0b0111'1111);
	REQUIRE(HL.HighByte() == 0x00);
	REQUIRE(SP.Value() == 0x00'00);
	REQUIRE(PC.Value() == 0x00'00);
	REQUIRE(IE == 0x00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_7_HL_NI, 0xCBBE")
{
	ClearRegisters();
	AF.SetLowByte(0b1111'0000);
	HL.SetValue(interruptAddress);
	...
	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_7_HL_NI);
	...
	REQUIRE(SP.Value() == 0x00'00);
	REQUIRE(PC.Value() == 0x00'00);
	REQUIRE(IE == 0b0111'1111);
}

TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "RES_7_A, 0xCBBF")
{
	ClearRegisters();
	AF.SetHighByte(0b1111'1111);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::RES_7_A);

	REQUIRE(numberOfCycles == 2);
	REQUIRE(AF.HighByte() == 0b0111'1111);
	REQUIRE(AF.LowByte() == 0b1111'0000);
	REQUIRE(BC.Value() == 0x00'00);
	REQUIRE(DE.Value() == 0x00'00);
	REQUIRE(HL.Value() == 0x00'00);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_0_B, 0xCBC0")
{
	ClearRegisters();
	BC.SetHighByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_0_B);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_0_C, 0xCBC1")
{
	ClearRegisters();
	BC.SetLowByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_0_C);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_0_D, 0xCBC2")
{
	ClearRegisters();
	DE.SetHighByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_0_D);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_0_E, 0xCBC3")
{
	ClearRegisters();
	DE.SetLowByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_0_E);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_0_H, 0xCBC4")
{
	ClearRegisters();
	HL.SetHighByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_0_H);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_0_L, 0xCBC5")
{
	ClearRegisters();
	HL.SetLowByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_0_L);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_0_HL_NI, 0xCBC6")
{
	ClearRegisters();
	AF.SetLowByte(0b1111'0000);
	HL.SetValue(interruptAddress);
	...
	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_0_HL_NI);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_0_A, 0xCBC7")
{
	ClearRegisters();
	AF.SetHighByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_0_A);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_1_B, 0xCBC8")
{
	ClearRegisters();
	BC.SetHighByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_1_B);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_1_C, 0xCBC9")
{
	ClearRegisters();
	BC.SetLowByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_1_C);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_1_D, 0xCBCA")
{
	ClearRegisters();
	DE.SetHighByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_1_D);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_1_E, 0xCBCB")
{
	ClearRegisters();
	DE.SetLowByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_1_E);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_1_H, 0xCBCC")
{
	ClearRegisters();
	HL.SetHighByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_1_H);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_1_L, 0xCBCD")
{
	ClearRegisters();
	HL.SetLowByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_1_L);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_1_HL_NI, 0xCBCE")
{
	ClearRegisters();
	AF.SetLowByte(0b1111'0000);
	HL.SetValue(interruptAddress);
	...
	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_1_HL_NI);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_1_A, 0xCBCF")
{
	ClearRegisters();
	AF.SetHighByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_1_A);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_2_B, 0xCBD0")
{
	ClearRegisters();
	BC.SetHighByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_2_B);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_2_C, 0xCBD1")
{
	ClearRegisters();
	BC.SetLowByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_2_C);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_2_D, 0xCBD2")
{
	ClearRegisters();
	DE.SetHighByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_2_D);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_2_E, 0xCBD3")
{
	ClearRegisters();
	DE.SetLowByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_2_E);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_2_H, 0xCBD4")
{
	ClearRegisters();
	HL.SetHighByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_2_H);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_2_L, 0xCBD5")
{
	ClearRegisters();
	HL.SetLowByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_2_L);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_2_HL_NI, 0xCBD6")
{
	ClearRegisters();
	AF.SetLowByte(0b1111'0000);
	HL.SetValue(interruptAddress);
	...
	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_2_HL_NI);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_2_A, 0xCBD7")
{
	ClearRegisters();
	AF.SetHighByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_2_A);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_3_B, 0xCBD8")
{
	ClearRegisters();
	BC.SetHighByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_3_B);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_3_C, 0xCBD9")
{
	ClearRegisters();
	BC.SetLowByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_3_C);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_3_D, 0xCBDA")
{
	ClearRegisters();
	DE.SetHighByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_3_D);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_3_E, 0xCBDB")
{
	ClearRegisters();
	DE.SetLowByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_3_E);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_3_H, 0xCBDC")
{
	ClearRegisters();
	HL.SetHighByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_3_H);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_3_L, 0xCBDD")
{
	ClearRegisters();
	HL.SetLowByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_3_L);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_3_HL_NI, 0xCBDE")
{
	ClearRegisters();
	AF.SetLowByte(0b1111'0000);
	HL.SetValue(interruptAddress);
	...
	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_3_HL_NI);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_3_A, 0xCBDF")
{
	ClearRegisters();
	AF.SetHighByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_3_A);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_6_B, 0xCBF0")
{
	ClearRegisters();
	BC.SetHighByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_6_B);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_6_C, 0xCBF1")
{
	ClearRegisters();
	BC.SetLowByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_6_C);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_6_D, 0xCBF2")
{
	ClearRegisters();
	DE.SetHighByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_6_D);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_6_E, 0xCBF3")
{
	ClearRegisters();
	DE.SetLowByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_6_E);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_6_H, 0xCBF4")
{
	ClearRegisters();
	HL.SetHighByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_6_H);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_6_L, 0xCBF5")
{
	ClearRegisters();
	HL.SetLowByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_6_L);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_6_HL_NI, 0xCBF6")
{
	ClearRegisters();
	AF.SetLowByte(0b1111'0000);
	HL.SetValue(interruptAddress);
	...
	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_6_HL_NI);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_6_A, 0xCBF7")
{
	ClearRegisters();
	AF.SetHighByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_6_A);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_7_B, 0xCBF8")
{
	ClearRegisters();
	BC.SetHighByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_7_B);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_7_C, 0xCBF9")
{
	ClearRegisters();
	BC.SetLowByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_7_C);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_7_D, 0xCBFA")
{
	ClearRegisters();
	DE.SetHighByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_7_D);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_7_E, 0xCBFB")
{
	ClearRegisters();
	DE.SetLowByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_7_E);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_7_H, 0xCBFC")
{
	ClearRegisters();
	HL.SetHighByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_7_H);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_7_L, 0xCBFD")
{
	ClearRegisters();
	HL.SetLowByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_7_L);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_7_HL_NI, 0xCBFE")
{
	ClearRegisters();
	AF.SetLowByte(0b1111'0000);
	HL.SetValue(interruptAddress);
	...
	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_7_HL_NI);
...
TEST_CASE_METHOD(TestFixtures::GameBoyCpuFixture, "SET_7_A, 0xCBFF")
{
	ClearRegisters();
	AF.SetHighByte(0b0000'0000);
	AF.SetLowByte(0b1111'0000);

	auto numberOfCycles = ExecuteInstruction(GameBoy::PrefixedOpCode::SET_7_A);
